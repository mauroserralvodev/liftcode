...
import { Marquee } from '@/components/marquee-lift';
import { FeaturesSectionDemo } from '@/components/cont-lift';
import Stats from '@/components/stats-lift';
import CardLift from '@/components/card-lift';
...
const Logos = {
    ...
    nextjs: () => (
      <svg
        className={'h-[20px] fill-[#ffffff] text-[#ffffff]'}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 394 79"
      >
    ...
    framer: () => (
      <div className={'h-fit flex items-center justify-start font-bold text-xl gap-3 text-[#ffffff]'}>
        <svg viewBox="0 0 14 21" role="presentation" className={'h-[30px] fill-[#ffffff]'}>
    ...
    return (
        <>
            {isMobile ? (
                ...
                <div className='max-w-6xl mx-auto bg-black py-14'>
                  <Marquee>
                  {arr.map((Logo, index) => (
                    <div
                      key={index}
                ...
                <div className='max-w-6xl mx-auto py-12 pb-36'>
                  <FeaturesSectionDemo/>
                </div>
            ...
            {showCreditNotification && (
                <div className="fixed top-4 right-4 bg-red-600/90 text-white px-6 py-3 rounded-lg backdrop-blur-sm flex items-center gap-4 animate-fade-in">
                    <div>
                        ...
                        <Link
                            href="/pricing"
                            className="text-sm underline mt-1 inline-block hover:text-blue-200"
                        >
