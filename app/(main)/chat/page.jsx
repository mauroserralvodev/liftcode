...
function page (){
    ...
    if (isMobile) {
        return (
        <div className="py-36 h-screen bg-black w-full mx-auto">
            ...
            <div className='flex justify-center items-center mt-10'>
                <Link href='/'>
                    <p className='border border-neutral-700 bg-transparent text-white/90 px-3 py-2 rounded-lg mr-2'>Go back</p>
                </Link>
                <a className='border border-neutral-700 bg-white/95 text-black px-3 py-2 rounded-lg mr-2 inline-flex items-center gap-x-2' href="/learn">
                    Learn more
  ...
  return (
    <div className="relative h-[50rem] sm:h-[59rem] w-full flex items-center justify-center">
        ...
        <div className='flex flex-col items-center py-24 px-56 gap-2 max-w-6xl mx-auto rounded-[2rem] backdrop-blur-sm'> {/* border border-black/20 bg-neutral-800/10 backdrop-blur-lg */}
            <Link href='/' className="flex text-lg items-center text-white mb-6">
                <img src="logow.png" className='w-48 sm:w-64' alt='Logo'/>
            </Link>
            {/* <p className='mb-10 mr-14 -mt-4 text-sm text-left text-neutral-800'>by <a href="https://brinpage.com/" className='hover:underline hover:text-neutral-800'>Brinpage</a></p> */}
            ...
            <p className='mb-10 text-neutral-200 mt-2 text-sm text-left'>By using Liftcode AI you accept the <a href="/terms" className='hover:underline hover:text-neutral-900'>terms and conditions</a> of the platform.</p>
        </div>
        
        <SignInDialog openDialog={openDialog} 
        closeDialog={(v)=>setOpenDialog(v)}/>

        {loading&&<div className='p-10 bg-neutral-900 opacity-70 absolute top-0 rounded-lg w-full h-full flex items-center justify-center'>
